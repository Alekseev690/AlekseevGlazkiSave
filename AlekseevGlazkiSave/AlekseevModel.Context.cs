...
namespace AlekseevGlazkiSave
{
    ...
    public partial class AlekseevGlazkiSaveEntities : DbContext
    {
        private static AlekseevGlazkiSaveEntities _context;

        public static AlekseevGlazkiSaveEntities GetContext()
        {
            if (_context == null)
            {
                _context = new AlekseevGlazkiSaveEntities();
            }
            return _context;
        }
